...
\end{lemma}
\begin{proof}
Let $\mu\in \PlanSp(X)$, $\nu \in \PlanSp(Y)$ and $\gamma \in \Pi(\mu, \nu)$. 	
...
\begin{proof}
 By Prokhorov and the tightness of the set of transport plans, we have compactness and lower semicontinuity of the cost function. Applying Weirestrass criterion we obtain the existence of an optimizer.
\end{proof}
